...
/*  A SEGUIR VALIDAÇÃO MODAL PÁGINA INICIAL (INDEX) */
...
function validarFormModal(Event){
    var form = document.forms["modal_form"];
...
/*  A SEGUIR VALIDAÇÃO FORMULÁRIO DA PÁGINA FALE CONOSCO */
...
if( document.forms["form_contato"] != undefined ){
    ...
    var inputs = document.querySelectorAll("form[name=form_contato] input[type=texto]");
